...
<template>
  <div class="wrapper flex flex-col items-center justify-center gap-5 w-full h-full font-noto">
    ...
    <div class="wrapper text-center flex items-center flex-col mb-24 gap-5 w-1/4 xl:w-1/3 lg:w-2/3 sm:w-full">
      ...
      <button @click.prevent="loginSend" @submit="loginSend" type="submit" class="mb-2 h-10 w-3/4 outline-none hover:text-light-default bg-light-200 rounded-lg px-3 py-1 outline-1 text-dark-400 focus:none  hover:bg-main-default text-lg transition-colors duration-200 font-medium">Login</button>
    </div>
